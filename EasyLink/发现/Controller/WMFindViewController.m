//
//  WMFindViewController.m
//  EasyLink
//
//  Created by 琦琦 on 16/9/14.
...
@interface WMFindViewController () {
...
@implementation WMFindViewController
...
- (void)viewDidLoad {
    ...
    _arrForKind = @[@"父亲节",@"情人节",@"儿童",@"出游踏春",@"读书",@"旅游",@"服装",@"限时购",@"一抹新鲜",@"创意生活",@"美食节"];
}
...
- (NSArray <NSString *> *)titles {
    ...
    return @[@"父亲节",@"情人节",@"儿童",@"出游踏春",@"读书",@"旅游",@"服装",@"限时购",@"一抹新鲜",@"创意生活",@"美食节"];
}
...
- (void) createAllViews {
    ...
    CGFloat height = [FindBtnView creatBtn].frame.size.height;
...
- (UIViewController *)pageController:(WMPageController *)pageController viewControllerAtIndex:(NSInteger)index {
    ...
    FindViewController *detailVC = [[FindViewController alloc] init];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [user setObject:@"2" forKey:@"CotrollerIndex"];
