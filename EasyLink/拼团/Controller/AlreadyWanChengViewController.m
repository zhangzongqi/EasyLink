//
//  AlreadyWanChengViewController.m
//  EasyLink
//
...
#import "AlreadyWanChengViewController.h"
...
@interface AlreadyWanChengViewController ()<UICollectionViewDataSource,UICollectionViewDelegate> {
...
@implementation AlreadyWanChengViewController
...
- (void) createUI {
    ...
    _numAndstatusVc.dingdanStatusLb.text = @"已完成";
    ...
    _pingtuanStatusVc.statusLb.text = @"感谢您的支持,欢迎再次光临!";
    ...
    [_sureReceiveBtn setTitle:@"去评价" forState:UIControlStateNormal];
    if (iPhone6SP) {
