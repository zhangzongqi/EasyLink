...
@interface YiGuanBiViewController ()<UICollectionViewDataSource,UICollectionViewDelegate> {
...
- (void) createUI {
    ...
    _numAndstatusVc.dingdanStatusLb.text = @"已关闭";
    ...
    _pingtuanStatusVc.statusLb.text = @"很遗憾:小拼购数量不足,订单已关闭";
    _pingtuanStatusVc.songDaTimeLb.text = @"已付款将在3~5日内原路退回,请注意查收!";
    ...
    _sureReceiveBtn.layer.borderColor = [FUIColorFromRGB(0xd5d5d5) CGColor];
    _sureReceiveBtn.layer.borderWidth = 1.0;
    [_sureReceiveBtn setTitleColor:FUIColorFromRGB(0x4e4e4e) forState:UIControlStateNormal];
    [_sureReceiveBtn setTitle:@"删除订单" forState:UIControlStateNormal];
    if (iPhone6SP) {
