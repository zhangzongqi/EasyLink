...
@interface WaitGoodsViewController ()<UICollectionViewDataSource,UICollectionViewDelegate> {
...
- (void) createUI {
    ...
    _numAndstatusVc.dingdanStatusLb.text = @"待收货";
    ...
    _pingtuanStatusVc.statusLb.text = @"宝贝配送中,请耐心等候";
    _pingtuanStatusVc.songDaTimeLb.text = @"预计送达时间:2017.2.22 17:00";
